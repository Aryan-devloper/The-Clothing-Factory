...
@include('header')
    ...
    <h1 style="font-family: serif;"><center><b>Shop Our Instagram</b></center></h1>
<br><br>
    <div class="container">
        <div class="row">
            <!-- Image Block 1 -->
            <div class="col-12 col-md-3" data-aos="fade-right">
                <img src="./img/m1.webp" alt="Image 1" class="img-fluid" style="width: 100%; height: auto;">
            </div>
    
            <!-- Image Block 2 -->
            <div class="col-12 col-md-3" data-aos="fade-right">
                <img src="./img/i3.avif" alt="Image 2" class="img-fluid" style="width: 100%; height: auto;">
            </div>
    
            <!-- Image Block 3 -->
            <div class="col-12 col-md-3" data-aos="fade-right">
                <img src="./img/i4.avif" alt="Image 3" class="img-fluid" style="width: 100%; height: auto;">
            </div>
    
            <!-- Image Block 4 -->
            <div class="col-12 col-md-3" data-aos="fade-right">
                <img src="./img/i5.avif" alt="Image 4" class="img-fluid" style="width: 100%; height: auto;">
            </div>
        </div>
    </div>
<br>
    <div class="container">
      <div class="row">
          <!-- Image Block 1 -->
          <div class="col-12 col-md-3" data-aos="fade-right">
              <img src="./img/i6.avif" alt="Image 1" class="img-fluid" style="width: 100%; height: auto;">
          </div>
  
          <!-- Image Block 2 -->
          <div class="col-12 col-md-3" data-aos="fade-right">
              <img src="./img/i7.avif" alt="Image 2" class="img-fluid" style="width: 100%; height: auto;">
          </div>
  
          <!-- Image Block 3 -->
          <div class="col-12 col-md-3" data-aos="fade-right">
              <img src="./img/i8.avif" alt="Image 3" class="img-fluid" style="width: 100%; height: auto;">
          </div>
...
<br>
  <div class="container">
    <div class="row">
        <!-- Image Block 1 -->
        <div class="col-12 col-md-3" data-aos="fade-right">
            <img src="./img/i9.avif" alt="Image 1" class="img-fluid" style="width: 100%; height: auto;">
        </div>

        <!-- Image Block 2 -->
        <div class="col-12 col-md-3" data-aos="fade-right">
            <img src="./img/f2.webp" alt="Image 2" class="img-fluid" style="width: 100%; height: auto;">
        </div>

        <!-- Image Block 3 -->
        <div class="col-12 col-md-3" data-aos="fade-right">
            <img src="./img/i10.avif" alt="Image 3" class="img-fluid" style="width: 100%; height: auto;">
        </div>

        <!-- Image Block 4 -->
        <div class="col-12 col-md-3" data-aos="fade-right">
            <img src="./img/i11.avif" alt="Image 4" class="img-fluid" style="width: 100%; height: auto;">
        </div>
    </div>
</div>
<br>
<div class="container">
  <div class="row">
      <!-- Image Block 1 -->
      <div class="col-12 col-md-3" data-aos="fade-right">
          <img src="./img/f3.webp" alt="Image 1" class="img-fluid" style="width: 100%; height: auto;">
      </div>

      <!-- Image Block 2 -->
      <div class="col-12 col-md-3" data-aos="fade-right">
          <img src="./img/i12.jpg" alt="Image 2" class="img-fluid" style="width: 100%; height: auto;">
      </div>

      <!-- Image Block 3 -->
      <div class="col-12 col-md-3" data-aos="fade-right">
          <img src="./img/i13.avif" alt="Image 3" class="img-fluid" style="width: 100%; height: auto;">
      </div>

      <!-- Image Block 4 -->
      <div class="col-12 col-md-3" data-aos="fade-right">
          <img src="./img/i14.avif" alt="Image 4" class="img-fluid" style="width: 100%; height: auto;">
      </div>
  </div>
</div>
